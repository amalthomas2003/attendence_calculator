...
def scrape_web_page():
    ...
    driver.get("https://www.rajagiritech.ac.in/stud/ktu/Student/Leave.asp?code=2023S5CS-B")
    ...
    sub_map_data = """1	101003/CS500A	 FORMAL LANGUAGES AND AUTOMATA THEORY
2	101003/CS500B	 COMPUTER NETWORKS
3	101003/CS500C	 SYSTEM SOFTWARE
4	101003/CS500D	 MICROPROCESSORS AND MICROCONTROLLERS
5	101003/CS500E	 MANAGEMENT OF SOFTWARE SYSTEMS
6	101908/CO500F	 DISASTER MANAGEMENT
7	101905/CS502H-B1	 Neural Networks and Deep Learning-B1
8	101003/CS522S	 SYSTEM SOFTWARE AND MICROPROCESSORS LAB
9	101003/CS522T	 DATABASE MANAGEMENT SYSTEMS LAB"""
    sub_map_dict = dict()
